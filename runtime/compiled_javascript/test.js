...
env = Object.assign({ "nativeExprToExe": (env => lazy(() => env["y"]()(lazy(() => env["b"]()(lazy(() => env["c"]()(lazy(() => env["c"]()(env["i"])(lazy(() => env["b"]()(env["strConss"])(lazy(() => env["c"]()(env["ListCons"])(lazy(() => env["ListCons"]()(lazy(() => env["ListCons"]()(lazy(() => env["_qadd"]()(env["Zero"])(lazy(() => env["_qadd"]()(env["Zero"])(env["two"])))))(env["ListEmpty"])))(env["ListEmpty"])))))))))))(lazy(() => env["b"]()(lazy(() => env["b"]()(lazy(() => env["b"]()(env["strConss"])))))(lazy(() => env["s"]()(lazy(() => env["b"]()(env["c"])(lazy(() => env["b"]()(lazy(() => env["b"]()(env["b"])))(lazy(() => env["b"]()(env["ListCons"])))))))(lazy(() => env["c"]()(lazy(() => env["b"]()(env["c"])(lazy(() => env["b"]()(env["ListCons"])))))(lazy(() => env["ListCons"]()(lazy(() => env["ListCons"]()(lazy(() => env["_qadd"]()(env["Zero"])(lazy(() => env["_qadd"]()(env["Zero"])(env["two"])))))(env["ListEmpty"])))(env["ListEmpty"])))))))))))))(env) }, env);
env = Object.assign({ "nativeDefToExe": (env => lazy(() => env["c"]()(env["i"])(lazy(() => env["b"]()(lazy(() => env["b"]()(env["strConss"])))(lazy(() => env["b"]()(lazy(() => env["c"]()(lazy(() => env["b"]()(env["ListCons"])(env["nativeExprToExe"])))))(lazy(() => env["c"]()(env["ListCons"])(lazy(() => env["ListCons"]()(lazy(() => env["ListCons"]()(lazy(() => env["_qadd"]()(env["two"])(env["two"])))(env["ListEmpty"])))(env["ListEmpty"])))))))))))(env) }, env);
...
let native = '';
native += toString((name) => env['pipe'](name)(fromString("i = u u")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("k = u (u i)     ")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("s = u k")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("b = s (k s) k")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("c = s (s (k s) (s (k k) s)) (k k)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("m = s i i")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("y = b m (c b (s i i))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("i = \\x x")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("k = \\a \\b a")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("s = \\a \\b \\c a c (b c)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("b = \\a \\b \\c a (b c)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("c = \\a \\b \\c a c b")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("m = \\x x x")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("y = \\f m (\\x f (x x))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("Bool = True | False")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("if = i")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("not = \\b b False True")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("lAnd = \\a \\b a b False")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("lOr = \\a \\b a True b")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("implies = \\a \\b a b True")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("xor = \\a \\b if a (not b) b")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eq = \\a \\b not $ xor a b")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("Nat = Zero | Succ n")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("one = Succ Zero")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("two = Succ one")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("three = Succ two")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("sub = \\a \\b b a (\\db sub (pred a) db)")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("isEQ = \\a \\b lAnd (isZero $ sub a b) (isZero $ sub b a)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("isLTE = \\a \\b isZero $ sub a b")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("isGTE = \\a \\b isLTE b a")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("isLT = \\a \\b not $ isGTE a b")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("isGT = \\a \\b not $ isLTE a b")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("min = \\a \\b if(isLT a b) a b")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("max = \\a \\b if(isGT a b) a b")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("diff = \\a \\b if (isLT a b) (sub b a) (sub a b)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("mod = \\a \\b if(isLT a b) a (mod (sub a b) b)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("div = \\a \\b if(isLT a b) Zero (Succ (div (sub a b) b))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("Pair = Pair a b")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("fst = \\pair pair (\\a \\b a)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("snd = \\pair pair (\\a \\b b)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("changeFst = \\pair \\f pair (\\a \\b Pair (f a) b)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("changeSnd = \\pair \\f pair (\\a \\b Pair a (f b))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("List = ListEmpty | ListCons head tail")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listIsEmpty = \\list list True (\\head \\tail False)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listIsNotEmpty = b not listIsEmpty")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("head = \\list list i (\\head \\tail head)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("tail = \\list list i (\\head \\tail tail)")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("reverse = \\l reverseBag l ListEmpty")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("unfold = \\x \\f ListCons x (unfold (f x) f)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("repeat = \\elem unfold elem i")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listConcat = \\l \\k l k $ \\h \\t ListCons h $ listConcat t k\n    ")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listReturn = \\x [x]")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listAddBack = \\l \\x listConcat l [x]")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("cfold = \\l \\x \\f ListCons x (l ListEmpty (\\head \\tail cfold tail (f x head) f))")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("listBind = \\f \\l foldl l [] (\\a \\b listConcat a (f b))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("map = \\f \\l l [] $ \\h \\t ListCons (f h) $ map f t")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("filter = \\f \\l l [] $ \\head \\tail if (f head) (ListCons head) i $ filter f tail")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("any = \\f \\l not $ listIsEmpty $ filter f l")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("all = \\f \\l not $ any (b not f) l")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("or = any i")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("and = all i")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("length = \\l foldl l Zero (b k Succ)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("zipWith = \\op \\l1 \\l2 \n    l1\n        ListEmpty\n        (\\h1 \\t1\n            l2\n                ListEmpty\n                (\\h2 \\t2\n                    ListCons \n                        (op h1 h2)\n                        (zipWith op t1 t2) \n                )\n        )")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("zip = zipWith Pair")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("listEquals = \\eq \\l1 \\l2 lAnd (isEQ (length l1) (length l2)) (and $ zipWith eq l1 l2)")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("listSort = y(\\sort \\lt \\l if(isGT (length l) one) ((\\mid listMerge lt (sort lt (take mid l))  (sort lt (drop mid l))) (div (length l) two)) l)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("intSort = listSort isLT")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listElementAt = \\l \\n head $ drop n l")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listStartsWith = \\eq \\l1 \\l2 listEquals eq (take (length l2) l1) l2")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("strIsEmpty = i listIsEmpty")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strIsNotEmpty = i b not strIsEmpty")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strEmpty = i ListEmpty")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strCons = i listConcat")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strStartsWith = i listStartsWith isEQ")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("strConss = \\strs strs \"\" $ \\head \\tail foldl tail head strCons")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strEquals = listEquals isEQ")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("Maybe = Just x | Nothing")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("maybeReturn = Just")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("maybeNothing = Nothing")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("maybeHasValue = Just_Dispatch (k True) False")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("maybeGetValue = Just_Dispatch i i")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("maybeBind = \\m \\f m f Nothing")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("maybeMap = \\m \\f m (b Just f) Nothing")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("maybeAlternative = \\m \\a m (k m) a")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("maybeTryGetValue = \\m \\a m i a")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_listIndexOfPred = \\l \\f \\offset l Nothing (\\head \\tail if(f head) (Just offset) (_listIndexOfPred tail f (Succ offset)))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listIndexOfPred = \\l \\f _listIndexOfPred l f 0")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listIndexOf = \\l \\eq \\x listIndexOfPred l (eq x)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_4 = Succ three")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_16 = mul _4 _4")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_32 = mul two _16")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_48 = mul three _16")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_10 = add two (add _4 _4)")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("strToN = \\str foldl str Zero (\\i \\c add (mul i _10) (sub c _48))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strFromB = \\b if(b) \"True\" \"False\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strFromS = \\s strConss [[96], s, [96]]")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strFromPair = \\fa \\fb \\p strConss [\"(\", fa (fst p), \" ; \", fb (snd p), \")\"]")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("LabeledTree = LabeledVertex label children")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("LabeledBinTree = LabeledBinLeaf label | LabeledBinVertex label left right")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("LabeledOrderedBinTree = LabeledOrderedBinLeaf label | LabeledOrderedBinVertex label left right lt")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("RBTree = RBTreeLeaf | RBTreeNodeRed label left right lt | RBTreeNodeBlack label left right lt")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nats0 = unfold Zero Succ")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nats = unfold one Succ")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("byteVals = take 256 nats0")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("toBinSeq = \\n map (c mod 2) $ takeWhile (b not isZero) (unfold n (c div 2))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("fromBinSeq = \\l foldl (zipWith (\\a \\b mul a (pow 2 b)) l nats0) 0 add")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nxor = \\a \\b fromBinSeq (listZipLonger (toBinSeq a) (toBinSeq b) 0 (\\x \\y mod (add x y) 2))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("isUpperCaseLetter = \\c lAnd (isGT c 64) (isLT c 91)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("isLowerCaseLetter = \\c lOr (lAnd (isGT c 96) (isLT c 123)) (isEQ c 95)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("isAlpha = \\c lOr (isUpperCaseLetter c) (isLowerCaseLetter c)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("alpha = filter isAlpha byteVals")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("isNum = \\c lAnd (isGT c 47) (isLT c 58)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("num = filter isNum byteVals")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("isAlphaNum = \\c lOr (isAlpha c) (isNum c)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("isWhiteSpace = \\c isLT c 34")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("whiteSpace = filter isWhiteSpace byteVals")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("toUpperCaseLetter = \\c if(isLowerCaseLetter c) (add c 32) c")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("toLowerCaseLetter = \\c if(isUpperCaseLetter c) (sub c 32) c")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("toUpperCaseString = map toUpperCaseLetter")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("toLowerCaseString = map toLowerCaseLetter")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("halt = \\x (if x halt i) x")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("primes = _primes (tail nats)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("fibs = ListCons 1 $ ListCons 1 $ zipWith add fibs (tail fibs)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listCutAt = \\l \\f l (Pair [] l) $ \\h \\t if(f h) (Pair [] l) (changeFst (listCutAt t f) (ListCons h))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strFromSS = \\ss foldl ss strEmpty (\\s \\x strCons s (strCons x [10]))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("xlistSplitAt = \\l \\f unfold (listCutAt l (k True)) (\\p changeSnd (listCutAt (snd p) f) tail)")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("listContains = \\list \\elem \\eq any (\\x eq elem x) list")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strContains = \\list \\elem listContains list elem isEQ")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listRepeat = \\n \\list listBind i (take n (repeat list))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strBurst = map (\\c [c])")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strTrim = \\str reverse $ dropWhile isWhiteSpace $ reverse $ dropWhile isWhiteSpace str")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("strFromMaybe = \\formatter \\m m (\\x strCons \"Just \" (formatter x)) \"Nothing\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("ParseResult = ParseResultFail | ParseResult remaining item")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseReturn = \\x (\\input ParseResult input x)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseFail = \\input ParseResultFail")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseOperation = \\conv \\res res ParseResultFail (\\remaining \\item ParseResult remaining (conv item))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseBindOperation = \\p \\conv (\\string parseOperation conv (p string))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parsePipe = \\p1 \\cp2 (\\input (p1 input) ParseResultFail (\\remaining \\item cp2 item remaining))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseBind = \\compose \\p1 \\p2 (\\input (p1 input) ParseResultFail (\\remaining \\item parseOperation (compose item) (p2 remaining)))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseBindDiscard = parseBind k")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseBindOverride = parseBind (k i)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseBindPair = parseBind Pair")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseCharIf = \\cond (\\string if (lAnd (not (listIsEmpty string)) (cond (head string))) (parseReturn (head string) (tail string)) (parseFail string))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseCharIf = \\cond (\\string string (parseFail string) $ \\head \\tail if (cond head) (parseReturn head tail) (parseFail string))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseCharX = \\set parseCharIf (\\c listContains set c isEQ)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseChar = \\c parseCharIf (isEQ c)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseSingle = parseCharIf (k True)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseString = \\str foldl (map parseChar str) (parseReturn strEmpty) (parseBind listAddBack)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseUntil = \\cond \\str (\\p parseReturn (fst p) (snd p)) (listCutAt str cond)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseWhile = \\cond parseUntil (b not cond)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseWhileMinOne = \\cond \\str (\\res if(listIsEmpty (ParseResult_Dispatch (\\remaining \\item item) \"\" res)) (parseFail str) res) (parseWhile cond str)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseOption = \\p1 \\p2 (\\string (p1 string) (p2 string) ParseResult)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseOptions = \\ps (\\string ps ParseResultFail (\\head \\tail (head string) (parseOptions tail string) ParseResult))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseWhitespace = parseWhile isWhiteSpace")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseWithWhitespace = \\p parseBindDiscard (parseBindOverride parseWhitespace p) parseWhitespace")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseToken = parseBind ListCons (parseCharIf isAlpha) (parseWhile isAlphaNum) ")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parsenumber = parseBindOperation (parseWhileMinOne isNum) strToN")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseAccept = \\restFilter \\res res Nothing (\\remaining \\item if(restFilter remaining) (Just item) Nothing)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseAcceptAll = parseAccept (k True)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("parseAcceptFullyConsumed = parseAccept listIsEmpty")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("mapCreate = \\eq Pair eq ListEmpty")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("mapGetAll = \\map \\key filter (\\x fst map key (fst x)) (snd map)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("mapHasKey = \\map \\key any (k True) (mapGetAll map key)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("mapCount = b length snd")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("mapadd = \\map \\key \\value changeSnd map (ListCons (Pair key value))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("mapRemove = \\map \\key changeSnd map (filter (\\elem not (fst map key (fst elem))))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("mapSet = \\map \\key \\value mapadd (mapRemove map key) key value")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("mapGet = \\map \\key snd (head (mapGetAll map key))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("idfCreate = mapCreate")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("idfHandle = \\idf \\x if(mapHasKey idf x) (Pair idf (mapGet idf x)) ((\\id Pair (mapadd idf x id) id) (mapCount idf))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("idfHandleX = \\idf \\xs foldl xs (Pair idf ListEmpty) (\\pair \\x (\\res Pair (fst res) (listAddBack (snd pair) (snd res))) (idfHandle (fst pair) x))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("idfCount = mapCount")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("newLine = [10]")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("empty = [32]")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("gDrawL = \\w \\y \\f listBind (\\x (f x y)) (take w nats0)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("gDraw = \\w \\h \\f listBind (\\y listConcat (gDrawL w y f) newLine) (take h nats0)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("gCanvas = k (k empty)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("gOverlay = \\sel \\col \\canvas \\x \\y if (sel x y) [col] (canvas x y)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("gPixel = \\x \\y \\col gOverlay (\\xx \\yy lAnd (isEQ xx x) (isEQ yy y)) col")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("gCircle = \\x \\y \\s \\col gOverlay (\\xx \\yy isGT (pow s 2) (add (pow (diff xx x) 2) (pow (diff yy y) 2))) col    ")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("beanEmpty = k Nothing")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("beanSet = \\mapping \\s \\x (\\query if(strEquals s query) (Just x) (mapping query))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("beanTryGet = \\mapping \\query mapping query")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("beanGet = \\mapping \\query maybeGetValue (mapping query)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("beanHas = \\mapping \\query maybeHasValue (mapping query)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("seqEmpty = Pair 0 i")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("seqLength = fst")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("seqGet = snd")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("seqSet = \\seq \\i \\x changeSnd seq (\\f \\ii if(isEQ i ii) x (f ii))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("seqaddFront = \\seq \\x Pair (Succ (seqLength seq)) (\\i if(isZero i) x (seqGet seq (pred i)))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("seqaddBack =  \\seq \\x Pair (Succ (seqLength seq)) (\\i if(isEQ i (seqLength seq)) x (seqGet seq i))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("seqConcat = \\s1 \\s2 Pair (add (seqLength s1) (seqLength s2)) (\\i if(isLT i (seqLength s1)) (seqGet s1 i) (seqGet s2 (sub i (seqLength s1))))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("seqRangeUnsafe = \\seq \\offset \\count Pair count (\\i seqGet seq (sub i offset))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("seqRange = \\seq \\offset \\count seqRangeUnsafe seq offset (min count (sub (seqLength seq) offset))")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("seqToList = \\seq map (seqGet seq) $ take (seqLength seq) nats0")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("listToSeq = \\list foldr list seqEmpty (\\seq \\x seqaddFront seq x)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_switchCond = \\listpairxres \\alt \\cond foldr listpairxres alt (\\inner \\pair if(cond (fst pair)) (snd pair) inner)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("switchCond = \\cond \\listpairxres \\alt _switchCond listpairxres alt cond")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("switch = \\obj \\listpairxres \\cond \\alt switchCond (cond obj) listpairxres alt")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("switchN = \\obj \\listpairnumres \\alt switch obj listpairnumres isEQ alt")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("getFirstConsumeMoreDeferred = \\mf \\v v \n                 (\\a \n                    y(\\self \\n if(isZero n) a (k (self (pred n)))) (mf a)\n                 )")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("getFirstConsumeMore = \\m getFirstConsumeMoreDeferred (k m)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharBrOpen = head \"(\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharBrClose = head \")\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharSqBrOpen = head \"[\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharSqBrClose = head \"]\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharComma = head \",\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharAbstr = head \"\\\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharOr = head \"|\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharAnd = head \"&\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharDollar = head \"$\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharAssign = 61")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eCharComment = 39")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eStrColon = [58]")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eIsQuot = \\x lOr (isEQ x 34) (isEQ x 96)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_eIsNewLine = \\x lOr (isEQ x 10) (isEQ x 13)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("Schar = ScharParenOpen\n      | ScharParenClose\n      | ScharAbstraction\n      | ScharAssign\n      | ScharSqBracketOpen\n      | ScharSqBracketClose\n      | ScharComma\n      | ScharSingleOr\n      | ScharDollar")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("scharID = \\s s 0 1 2 3 4 5 6 7 8")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("scharEQ = \\a \\b isEQ (scharID a) (scharID b)")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("tokenLiteral = \\literal if(isLowerCaseLetter (head literal)) (TokenLiteralLower literal) (TokenLiteralUpper literal) ")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("token_String_list = \\xs strJoin (map token_String xs) \" \"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatParenOpen        = parseBindOperation (parseChar _eCharBrOpen)    $ k $ TokenSpecialChar ScharParenOpen")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatParenClose       = parseBindOperation (parseChar _eCharBrClose)   $ k $ TokenSpecialChar ScharParenClose")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatSqBracketOpen    = parseBindOperation (parseChar _eCharSqBrOpen)  $ k $ TokenSpecialChar ScharSqBracketOpen")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatSqBracketClose   = parseBindOperation (parseChar _eCharSqBrClose) $ k $ TokenSpecialChar ScharSqBracketClose")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatComma            = parseBindOperation (parseChar _eCharComma)     $ k $ TokenSpecialChar ScharComma")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatAbstraction      = parseBindOperation (parseChar _eCharAbstr)     $ k $ TokenSpecialChar ScharAbstraction")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatAssign           = parseBindOperation (parseChar _eCharAssign)    $ k $ TokenSpecialChar ScharAssign")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatSingleOr         = parseBindOperation (parseChar _eCharOr)        $ k $ TokenSpecialChar ScharSingleOr")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatDollar           = parseBindOperation (parseChar _eCharDollar)    $ k $ TokenSpecialChar ScharDollar")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatLiteral = parseBindOperation parseToken (\\x tokenLiteral x)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatConstS  = parseBindOperation (parseBindOverride (parseCharIf _eIsQuot) (parseBindDiscard (parseUntil _eIsQuot) (parseCharIf _eIsQuot))) (\\x TokenConstS x)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatConstN  = parseBindOperation parsenumber (\\x TokenConstN x)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("eatComment = parseBindOperation (parseBindOverride (parseChar _eCharComment) (parseUntil _eIsNewLine)) (\\x TokenComment x)")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("token_Process = b parseAcceptFullyConsumed $ parseWhilesuccessful eatSomething")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("token_Run = \\s (strFromMaybe i (maybeMap (token_Process s) token_String_list))")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("syntaxCreateApplication = \\syntaxes foldl (tail syntaxes) (head syntaxes) SyntaxApplication")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("syntaxCreateAbstraction = \\literals \\body foldr literals body (\\x \\lit SyntaxAbstraction lit x)")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("syntax_String_list = \\xs strJoin (map syntax_String xs) \"; \"")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("cstrParseCloseParen = cstrParseSChar ScharParenClose")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("cstrParseCloseSqBr = cstrParseSChar ScharSqBracketClose")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("cstrParseComma = cstrParseSChar ScharComma")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("cstrParseAssign = cstrParseSChar ScharAssign")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("cstrParseSingleOr = cstrParseSChar ScharSingleOr")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("cstrParseDollar = cstrParseSChar ScharDollar")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("cstrSyntaxEverything = parseWhilesuccessful $ y cstrSyntaxApplication")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("syntax_Process = b parseAcceptFullyConsumed cstrSyntaxEverything")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("syntax_Run = \\s strFromMaybe i $ maybeMap (maybeBind (token_Process s) syntax_Process) syntax_String_list")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("NativeDefinition = NativeAssignment literal o   ")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("NativeExpression = NativeLiteral literal        \n                 | NativeApplication o1 o2      \n        ")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("getCollisionFreeLiteral = \\literal strCons \":arg:\" literal")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("nativeDef_String_list = \\xs strJoin (map nativeExpr_String xs) \"; \"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeExpr_String_list = \\xs strJoin (map nativeDef_String xs) \"; \"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeI = NativeLiteral \":bound:i\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeK = NativeLiteral \":bound:k\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeB = NativeLiteral \":bound:b\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeC = NativeLiteral \":bound:c\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeS = NativeLiteral \":bound:s\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeY = NativeLiteral \":bound:y\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeListEmpty = NativeLiteral \"ListEmpty\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeListCons = NativeLiteral \"ListCons\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeStrToN = NativeLiteral \"strToN\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("native0 = NativeLiteral \"Zero\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("native1 = NativeLiteral \"one\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("native2 = NativeLiteral \"two\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("native3 = NativeLiteral \"three\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeSucc = NativeLiteral \"Succ\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeMul = NativeLiteral \"mul\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("nativeQadd = NativeLiteral \"_qadd\"")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("_sToNative = \\value foldr value nativeListEmpty (\\value \\item NativeApplication (NativeApplication nativeListCons (_nToNative item)) value)")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("_createUniqueNameFromS = \\s strCons \":bound:\" s")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("_make__ValueDef = \\syntaxExpression SyntaxAssignment \"__value\" syntaxExpression")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("syntaxToNative = \\s map finalizeNativeDefs (_syntaxToNativeDefs s)")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_nlB = NativeLiteral \"b\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_nlMB = NativeLiteral \"maybeBind\"")));
process.stderr.write('.');

native += toString((name) => env['pipe'](name)(fromString("_nlTA = NativeLiteral \"typeApply\"")));
process.stderr.write('.');
...
native += toString((name) => env['pipe'](name)(fromString("native_Process = \\synts maybeReturn $ listBind syntaxToNative synts")));
process.stderr.write('.');
